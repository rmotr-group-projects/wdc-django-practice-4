...
def task_1_q_object_advanced_lookup():
    ...
    """
    return Song.objects.filter(Q(title__icontains='Ground') | Q(artist__artistic_name__startswith='Ed'))
...
def task_2_q_object_advanced_lookup():
    ...
    """
    return Song.objects.filter(Q(title__istartswith='S') | Q(title__istartswith='C'),
