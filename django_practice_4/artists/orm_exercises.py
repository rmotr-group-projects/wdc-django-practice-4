...
def task_1_q_object_advanced_lookup():
    ...
    return Song.objects.filter(Q(title__icontains='Ground') | Q(artist__artistic_name__istartswith='Ed'))
...
def task_2_q_object_advanced_lookup():
    ...
    return Song.objects.filter((Q(title__startswith='S') | Q(title__startswith='C')) & Q(artist__artistic_name__contains='W'))
